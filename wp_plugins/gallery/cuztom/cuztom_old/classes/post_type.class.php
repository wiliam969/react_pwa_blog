	...
	function register_post_type()
	{
		...
		$labels = array_merge(
			array(
				...
				'all_items' 			=> sprintf( __( 'Alle %s', 'cuztom' ), $this->plural ),
				'add_new' 				=> sprintf( _x( 'Neu', '%s', 'cuztom' ), $this->title ),
				'add_new_item' 			=> sprintf( __( 'Add New %s', 'cuztom' ), $this->title ),
				'edit_item' 			=> sprintf( __( '%s bearbeiten', 'cuztom' ), $this->title ),
				'new_item' 				=> sprintf( __( '%s neues', 'cuztom' ), $this->title ),
				'view_item' 			=> sprintf( __( 'Zeige %s', 'cuztom' ), $this->title ),
				'items_archive'			=> sprintf( __( '%s Archive', 'cuztom' ), $this->title ),
				'search_items' 			=> sprintf( __( 'Suche %s', 'cuztom' ), $this->plural ),
				'not_found' 			=> sprintf( __( 'Keine %s gefunden', 'cuztom' ), $this->plural ),
				'not_found_in_trash' 	=> sprintf( __( 'Keine %s im Papierkorb', 'cuztom' ), $this->plural ),
				'parent_item_colon'		=> sprintf( __( '%s Eltern', 'cuztom' ), $this->title ),
			),
			$this->labels
		);
