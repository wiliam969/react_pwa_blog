	...
	function register_taxonomy()
	{
		...
		$labels = array_merge(
			array(
			    ...
			    'parent_item' 			=> sprintf( __( '%s Eltern', 'cuztom' ), $this->title ),
			    'parent_item_colon' 	=> sprintf( __( '%s Eltern:', 'cuztom' ), $this->title ),
			    'edit_item' 			=> sprintf( __( '%s bearbeiten', 'cuztom' ), $this->title ),
			    'update_item' 			=> sprintf( __( '%s update', 'cuztom' ), $this->title ),
			    'add_new_item' 			=> sprintf( __( 'Neu %s', 'cuztom' ), $this->title ),
			    'new_item_name' 		=> sprintf( __( 'Neu %s Name', 'cuztom' ), $this->title ),
